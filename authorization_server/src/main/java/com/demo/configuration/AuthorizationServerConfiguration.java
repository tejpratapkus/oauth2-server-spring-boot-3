...
import com.demo.configuration.federated.identity.FederatedIdentityConfigurer;
import com.demo.configuration.jose.Jwks;
import com.demo.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationConverter;
import com.demo.oauth2.authentication.OAuth2ResourceOwnerPasswordAuthenticationProvider;
import com.demo.oauth2.customizer.jwt.JwtCustomizer;
import com.demo.oauth2.customizer.jwt.JwtCustomizerHandler;
import com.demo.oauth2.customizer.jwt.impl.JwtCustomizerImpl;
import com.demo.oauth2.customizer.token.claims.OAuth2TokenClaimsCustomizer;
import com.demo.oauth2.customizer.token.claims.impl.OAuth2TokenClaimsCustomizerImpl;
import com.demo.oauth2.repository.OAuth2AuthorizationConsentRepository;
import com.demo.oauth2.repository.OAuth2AuthorizationRepository;
import com.demo.oauth2.service.impl.JpaOAuth2AuthorizationConsentService;
import com.demo.oauth2.service.impl.JpaOAuth2AuthorizationService;
