...
insert into oauth2_client (client_id, client_id_issued_at, client_name, client_secret, client_secret_expires_at, authentication_method, authorization_grant_type, scopes, redirect_uris, registered,
  ...
  VALUES ( -- password
  'authorization-code-client-id', CURRENT_TIMESTAMP, 'authorization-code-client-name', '{noop}secret1', null, 'client_secret_post', 'authorization_code,refresh_token', 'message.read,message.write', 'http://127.0.0.1:8080/auth_client_server/authorized', 0,
